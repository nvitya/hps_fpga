...
`timescale 1 ps / 1 ps
module test4_soc_mm_interconnect_0 (
		...
		input  wire        led_pio_reset_reset_bridge_in_reset_reset,                           //                           led_pio_reset_reset_bridge_in_reset.reset
	...
	wire  [112:0] led_pio_s1_agent_rf_source_data;                      // led_pio_s1_agent:rf_source_data -> led_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [112:0] led_pio_s1_agent_rsp_fifo_out_data;                   // led_pio_s1_agent_rsp_fifo:out_data -> led_pio_s1_agent:rf_sink_data
	...
	wire  [111:0] led_pio_s1_agent_rp_data;                             // led_pio_s1_agent:rp_data -> router_002:sink_data
	...
	wire          cmd_mux_src_valid;                                    // cmd_mux:src_valid -> led_pio_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                     // cmd_mux:src_data -> led_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                    // led_pio_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                  // cmd_mux:src_channel -> led_pio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                            // cmd_mux:src_startofpacket -> led_pio_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                              // cmd_mux:src_endofpacket -> led_pio_s1_burst_adapter:sink0_endofpacket
	wire          led_pio_s1_burst_adapter_source0_valid;               // led_pio_s1_burst_adapter:source0_valid -> led_pio_s1_agent:cp_valid
	wire  [111:0] led_pio_s1_burst_adapter_source0_data;                // led_pio_s1_burst_adapter:source0_data -> led_pio_s1_agent:cp_data
	wire          led_pio_s1_burst_adapter_source0_ready;               // led_pio_s1_agent:cp_ready -> led_pio_s1_burst_adapter:source0_ready
	wire    [1:0] led_pio_s1_burst_adapter_source0_channel;             // led_pio_s1_burst_adapter:source0_channel -> led_pio_s1_agent:cp_channel
	...
	wire          led_pio_s1_agent_rdata_fifo_out_valid;                // led_pio_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] led_pio_s1_agent_rdata_fifo_out_data;                 // led_pio_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          led_pio_s1_agent_rdata_fifo_out_ready;                // avalon_st_adapter:in_0_ready -> led_pio_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (led_pio_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (led_pio_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	test4_soc_mm_interconnect_0_router router (
	...
	test4_soc_mm_interconnect_0_router router_001 (
	...
	test4_soc_mm_interconnect_0_router_002 router_002 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (led_pio_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	test4_soc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test4_soc_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test4_soc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (led_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test4_soc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (led_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test4_soc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test4_soc_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test4_soc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (led_pio_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
